...
package com.experiments.core.domain.exceptions;
...
public class PermissionDeniedException extends Exception {
    ...
    public PermissionDeniedException(@NonNull String[] askedPermissions) {
        super();
        this.askedPermissions = askedPermissions;
        this.deniedPermissions = null;
    }

    public PermissionDeniedException(@Nullable String[] askedPermissions, @Nullable String[] deniedPermissions) {
        super();
        this.askedPermissions = askedPermissions;
    ...
    @Nullable
    public String[] getAskedPermissions() {
