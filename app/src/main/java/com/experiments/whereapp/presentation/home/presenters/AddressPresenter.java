...
import com.experiments.whereapp.presentation.home.views.AddressView;
...
public class AddressPresenter extends BasePresenter<AddressView> {
    ...
    public void onUpdateCurrentPlaceEvent(OnUpdateCurrentPlace onUpdateCurrentPlace) {
        Place place = onUpdateCurrentPlace.getCurrentPlace().getPlaceData();
        if (place == null) {
            view.stopAnimatingAddress(true);
    ...
    @DebugLog
    @Subscribe(threadMode = ThreadMode.MAIN)
    public void onErrorGettingPlaceDetails(OnErrorGettingPlace onErrorGettingPlace) {
        Throwable exception = onErrorGettingPlace.getException();
