...
package com.experiments.whereapp.presentation.home.presenters;
...
import com.experiments.core.domain.helpers.location.GetPlaceCallback;
import com.experiments.core.domain.helpers.location.LocationUpdatesListener;
import com.experiments.core.domain.helpers.location.LocationUpdatesManager;
import com.experiments.core.domain.helpers.location.PlaceDataWrapper;
import com.experiments.core.presentation.presenters.BasePresenter;
import com.experiments.whereapp.domain.events.OnErrorGettingPlace;
import com.experiments.whereapp.domain.events.OnUpdateCurrentPlace;
...
public class HomePresenter extends BasePresenter<HomeScreenView> implements LocationUpdatesListener {
    ...
    public void checkTurnOnLocationResult(LocationSettingsStates locationSettingsStates) {
        if (locationSettingsStates.isLocationUsable()) {
            ...
            eventBus.post(new OnErrorGettingPlace(new Throwable("Permission was denied by user")));
        }
    }
    ...
    public void postUpdateCurrentPlaceEvent(PlaceDataWrapper currentPlace) {
        eventBus.post(new OnUpdateCurrentPlace(currentPlace));
    }

    @DebugLog
    public void postErrorGettingPlaceEvent(Throwable t) {
        eventBus.post(new OnErrorGettingPlace(t));
    }
}
